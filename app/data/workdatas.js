...
export const workdatas = [
    ...
    },
    {
        ...
        status: true,
        title: "Simple Closet",
        tools: ["Next.js","React","Supabase","PostgreSQL","PWA","WeatherAPI"],
    ...
    },
    {
        ...
        description: ["PythonとMySQLの練習で、ECサイトのPCサイズデモを制作しました。","簡易的なものですが、ユーザ側の商品購入機能と、店舗側の管理者機能を実装しています。","※Render無料枠でのデプロイのため、起動まで1分ほどかかります","---------------------------------------------","【デモ用アカウント】","ユーザID：demo@demo.com","管理者ID：staff@demo.com","パスワード（共通）：portfolio2026"],
    },
    {
        slug: "work5",
        status: false,
        ...
        image: "/workimages/sisan-doc.jpg",
        gitUrl: "",
        DocumentUrl: "https://canva.link/mlwm8y89r6d66kv",
        vercelUrl: "",
        description: ["前職の経験を活かし、IT資産の購入から廃棄まで一元的に管理できるシステムを企画中です。"],
    },
    // {
    //     slug: "work6",
    //     status: true,
